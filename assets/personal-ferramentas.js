...
(function () {
  ...
  function setupPers() {
    ...
    var panes = partition(root, "persArea", "Personalizar", [["marca", "Identidade, cores e logo"], ["fotos", "Fotos dos treinos"], ["beneficios", "Benefícios e loja"], ["medalhas", "Medalhas"]]);
    ...
    var identidade = $("marcaForm"); if (identidade) panes.marca.prepend(identidade.closest(".ptmarca"));
