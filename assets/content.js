...
self.MT_APPS = [
  { slug: "sistema", file: "apps/sistema.html", icone: "🖥", title: "Sistema da Academia", desc: "O sistema completo: menu com todas as áreas, Dashboard com os números da academia e atalhos de venda e check-in.", standalone: true },
  ...
  { slug: "app-grade", file: "apps/grade.html", icone: "📅", title: "Grade de Aulas", desc: "A grade da semana: vagas, professor, sala, participantes por aula e agendamento sob demanda." },
  ...
  { slug: "app-personal-studio", file: "personal.html", icone: "🏋️‍♂️", title: "Módulo TORQUE ON Personal", desc: "O sistema do personal trainer: alunos, agenda de sessões, pagamentos com cobrança via WhatsApp e treinos — instala como app, offline e sincronizado. Página de vendas: personal-vendas.html" },
  ...
  { slug: "app-recebimentos", file: "apps/recebimentos.html", icone: "💰", title: "Recebimentos por Centro de Receita", desc: "O que entrou por centro de receita no período: mensalidades, produtos e locações somados por origem, com o total." },
  { slug: "app-vencimentos", file: "apps/vencimentos.html", icone: "⏰", title: "Vencimentos", desc: "Tudo que vence no período num só lugar: contratos, avaliações físicas e fichas de treino — com contato pronto no WhatsApp." },
  ...
  { slug: "app-wellhub", file: "apps/wellhub.html", icone: "🤝", title: "Wellhub e TotalPass", desc: "A operação dos agregadores: valide o check-in do app na recepção, importe o CSV do portal do parceiro com conciliação automática e exporte tudo." },
  { slug: "app-config-financeiro", file: "apps/config-financeiro.html", icone: "💰", title: "Config · Financeiro e Venda", desc: "As regras da Configuração Inicial: formas de pagamento, multa e juros por atraso, régua de inadimplência, recorrência e regras de venda/recibo." },
  { slug: "app-config-avancado", file: "apps/config-avancado.html", icone: "🔧", title: "Config · Avançado", desc: "A tela Avançado: WOD, validade da avaliação física, risco de abandono por presença semanal, limites de convidados, segurança e suspensões." },
  { slug: "app-cargos", file: "apps/cargos.html", icone: "🏷️", title: "Cargos", desc: "Os cargos da equipe: crie, renomeie e veja quantos colaboradores tem em cada um — aparece na ficha e nos filtros." },
  { slug: "app-areas", file: "apps/areas.html", icone: "📍", title: "Áreas", desc: "As áreas da academia — sala de musculação, box, bike, área kids — com capacidade e equipamentos, como referência pra grade e ocupação." },
  { slug: "app-atividades", file: "apps/atividades.html", icone: "🎨", title: "Atividades", desc: "O catálogo de modalidades da grade com cor e grupo (BOXE, CROSSFIT, HIIT…) — ao criar aula na Grade, o nome sugere e a cor vem sozinha." },
  { slug: "app-aulas-personal", file: "apps/aulas-personal.html", icone: "🤸", title: "Aulas de Personal", desc: "O catálogo de aulas de personal: preço interno e externo, meia aula, aula teste e máximo de clientes por aula." },
  { slug: "app-permissoes", file: "apps/permissoes.html", icone: "🔐", title: "Permissões", desc: "Perfis de acesso (Acesso Total, Consultor, Professor…): defina as telas de cada perfil, duplique e aplique na ficha do colaborador." },
  { slug: "app-horarios-funcionamento", file: "apps/horarios-funcionamento.html", icone: "🕐", title: "Horários de Funcionamento", desc: "O funcionamento da unidade dia a dia (com segunda faixa pra fechar no almoço) e o cadastro de feriados com horário especial." },
  { slug: "app-servicos", file: "apps/servicos.html", icone: "🧾", title: "Serviços", desc: "Serviços avulsos — diária, avaliação física, aula experimental — com dados financeiros e reajuste de valores em lote." },
  { slug: "app-biometria", file: "apps/biometria.html", icone: "📷", title: "Biometria e Catraca", desc: "Reconhecimento facial pela webcam (IA no navegador, sem internet) com check-in automático, e integração com a catraca Control iD: envia alunos e importa os acessos." },
  ...
  { slug: "app-app-aluno", file: "apps/app-aluno.html", icone: "📲", title: "App do Aluno", desc: "O aplicativo que o aluno recebe ao se matricular: carteirinha digital, plano, treino, avaliação, grade da semana e mural de avisos — personalizável e offline." },
  { slug: "app-suporte", file: "apps/suporte.html", icone: "📚", title: "Central de Ajuda", desc: "Tudo que existe no sistema em formato de tutorial passo a passo, com busca — do check-in ao chatbot com IA." },
  { slug: "app-copiloto", file: "apps/copiloto.html", icone: "🧠", title: "Copiloto IA", desc: "O radar de cancelamento: quem está em risco de sair, por quê, e o plano de ação da semana — com análise do Claude sobre a sua base." },
  { slug: "app-totem", file: "apps/totem.html", icone: "🖥", title: "Totem de Autoatendimento", desc: "Tablet fixo na entrada: o aluno faz check-in sozinho pelo nome ou QR da carteirinha, vê o WOD do dia e os avisos.", standalone: true },
  { slug: "app-chat", file: "apps/chat.html", icone: "🤖", title: "Chat e IA (WhatsApp + Instagram)", desc: "Caixa de entrada unificada: mensagens do WhatsApp e do Instagram chegam no sistema e você responde manualmente ou deixa a IA (Claude) responder sozinha." },
  { slug: "app-perfil-aluno", file: "apps/perfil-aluno.html", icone: "👤", title: "Perfil do Aluno", desc: "A ficha completa: bloqueios e pendências, contratos, cobranças, compras, frequência e risco de abandono." },
  { slug: "app-niveis", file: "apps/niveis.html", icone: "🥋", title: "Níveis e Graduação", desc: "Faixas e graduações: trilhas com progresso por sessões ou dias, e comemoração quando o aluno sobe de nível." },
  ...
  { slug: "app-colaborador", file: "apps/colaborador.html", icone: "👔", title: "Ficha do Colaborador", desc: "A ficha do funcionário: contratação com salário (lança na Folha), horário de trabalho, permissões e acesso." },
  ...
  { slug: "app-descontos", file: "apps/descontos.html", icone: "🏷️", title: "Descontos", desc: "Descontos oficiais com regras: % ou valor, vigência, limite de idade, recorrência, autorização e quem pode aplicar." },
  { slug: "app-contagem", file: "apps/contagem.html", icone: "🔢", title: "Contagem de Clientes", desc: "A ocupação de áreas: contagens de musculação/cardio por horário, pico, média e lotação por hora." },
  { slug: "app-logs", file: "apps/logs.html", icone: "📋", title: "Log Geral", desc: "A trilha de auditoria: cada alteração de dados com o que mudou, quando e quem estava logado (últimas 400)." },
  { slug: "app-precos", file: "apps/precos.html", icone: "🏷️", title: "Tabela de Preços", desc: "A tabela de preços sempre atualizada: planos, produtos e o valor do dia para a equipe de vendas, com impressão e export." },
  { slug: "app-suspensoes", file: "apps/suspensoes.html", icone: "⏸", title: "Suspensões", desc: "Congelamento de contrato: vigentes, programadas e finalizadas, com motivo, reativação e bloqueio automático na entrada." },
  ...
  { slug: "app-adquirentes", file: "apps/adquirentes.html", icone: "🧾", title: "Adquirentes e Taxas", desc: "Taxas da maquininha por forma de pagamento + simulador de valor líquido — o \"valor de baixa\" explicado." },
