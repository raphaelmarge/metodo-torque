...
self.MT_APPS = [
  ...
  { slug: "app-personal-studio", file: "personal.html", icone: "🏋️‍♂️", title: "Módulo TORQUESYS Personal", desc: "O sistema do personal trainer: alunos, agenda de sessões, pagamentos com cobrança via WhatsApp e treinos — instala como app, offline e sincronizado. Página de vendas: personal-vendas.html" },
  ...
  { slug: "app-config-financeiro", file: "apps/config-financeiro.html", icone: "💰", title: "Config · Financeiro e Venda", desc: "As regras da Configuração Inicial do EVO: formas de pagamento, multa e juros por atraso, régua de inadimplência, recorrência e regras de venda/recibo." },
  { slug: "app-config-avancado", file: "apps/config-avancado.html", icone: "🔧", title: "Config · Avançado", desc: "A tela Avançado do EVO: WOD, validade da avaliação física, risco de abandono por presença semanal, limites de convidados, segurança e suspensões." },
  { slug: "app-cargos", file: "apps/cargos.html", icone: "🏷️", title: "Cargos", desc: "Os cargos da equipe como no EVO: crie, renomeie e veja quantos colaboradores tem em cada um — aparece na ficha e nos filtros." },
  ...
  { slug: "app-aulas-personal", file: "apps/aulas-personal.html", icone: "🤸", title: "Aulas de Personal", desc: "O catálogo de aulas de personal como no EVO: preço interno e externo, meia aula, aula teste e máximo de clientes por aula." },
  { slug: "app-permissoes", file: "apps/permissoes.html", icone: "🔐", title: "Permissões", desc: "Perfis de acesso como no EVO (Acesso Total, Consultor, Professor…): defina as telas de cada perfil, duplique e aplique na ficha do colaborador." },
  ...
  { slug: "app-servicos", file: "apps/servicos.html", icone: "🧾", title: "Serviços", desc: "Serviços avulsos como no EVO — diária, avaliação física, aula experimental — com dados financeiros e reajuste de valores em lote." },
