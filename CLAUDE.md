...
- No editor de Nutrição, as trocas aprovadas ocupam uma linha própria também no desktop. A linha flexível não comprime o nome do alimento até quebrar letra por letra. Correção restrita a #pnRefeicoes; biblioteca, porções, macros, rascunho e publicação permanecem iguais. Regressão em tests/test-nutricao-editor-layout.js.
