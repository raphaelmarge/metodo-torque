...
## v806 — Nutrição integrada ao Personal (adição solicitada pelo Raphael)
...
- `assets/nutricao-core.js` é autocontido e serializado no builder. Diário em `ptnutricao`, fila em `ptnutriFila`; a troca de identidade limpa ambos. Cada refeição guarda seu snapshot confirmado, inclusive quantidade e foto reduzida.
