...
|---|---|
| App em | **mt-v780** |
| Estado do repo em | 2026-09-06 (commit `7171c17`) |
...
vez em **(fora de um lote de versão)** (2026-09-06), e o app está em **mt-v780**.
...
O motor (`app/aluno-builder.js`) encostou em **(fora de um lote de versão)** (2026-09-06).
