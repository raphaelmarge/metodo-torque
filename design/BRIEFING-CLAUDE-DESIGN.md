...
|---|---|
| App em | **mt-v653** |
| Estado do repo em | 2026-08-29 (commit `6fc3b25`) |
| Repositório | `raphaelmarge/metodo-torque` |
| Lançamentos no histórico | 115 |
...
vez em **mt-v601** (2026-08-25), e o app está em **mt-v653** — ou seja, **52 versões** aconteceram depois disso.
