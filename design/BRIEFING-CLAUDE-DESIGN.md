...
|---|---|
| App em | **mt-v820** |
| Estado do repo em | 2026-09-10 (commit `cea34a3`) |
...
vez em **(fora de um lote de versão)** (2026-09-10), e o app está em **mt-v820**.
...
O motor (`app/aluno-builder.js`) encostou em **(fora de um lote de versão)** (2026-09-10).
