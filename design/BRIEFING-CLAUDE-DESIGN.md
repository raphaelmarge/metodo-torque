...
|---|---|
| App em | **mt-v836** |
| Estado do repo em | 2026-09-15 (commit `22b091f`) |
...
vez em **(fora de um lote de versão)** (2026-09-15), e o app está em **mt-v836**.
...
O motor (`app/aluno-builder.js`) encostou em **(fora de um lote de versão)** (2026-09-15).
