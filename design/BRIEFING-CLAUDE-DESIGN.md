...
|---|---|
| App em | **mt-v641** |
| Estado do repo em | 2026-08-27 (commit `80bfdfb`) |
| Repositório | `raphaelmarge/metodo-torque` |
| Lançamentos no histórico | 103 |
...
vez em **mt-v601** (2026-08-25), e o app está em **mt-v641** — ou seja, **40 versões** aconteceram depois disso.
...
O motor (`app/aluno-builder.js`) encostou em **mt-v641** (2026-08-27).
