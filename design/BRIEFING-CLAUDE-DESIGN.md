...
|---|---|
| App em | **mt-v772** |
| Estado do repo em | 2026-09-04 (commit `cdb2797`) |
| Repositório | `raphaelmarge/metodo-torque` |
| Lançamentos no histórico | 233 |
...
vez em **(fora de um lote de versão)** (2026-09-02), e o app está em **mt-v772**.
...
O motor (`app/aluno-builder.js`) encostou em **mt-v772** (2026-09-04).
