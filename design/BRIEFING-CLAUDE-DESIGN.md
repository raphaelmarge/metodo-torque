...
|---|---|
| App em | **mt-v829** |
| Estado do repo em | 2026-09-11 (commit `f40a6c4`) |
...
vez em **(fora de um lote de versão)** (2026-09-11), e o app está em **mt-v829**.
...
O motor (`app/aluno-builder.js`) encostou em **(fora de um lote de versão)** (2026-09-11).
