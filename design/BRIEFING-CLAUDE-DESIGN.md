...
|---|---|
| App em | **mt-v839** |
| Estado do repo em | 2026-09-16 (commit `0c644c6`) |
...
vez em **(fora de um lote de versão)** (2026-09-16), e o app está em **mt-v839**.
...
O motor (`app/aluno-builder.js`) encostou em **(fora de um lote de versão)** (2026-09-16).
