...
|---|---|
| App em | **mt-v835** |
| Estado do repo em | 2026-09-15 (commit `9f3bc75`) |
...
vez em **(fora de um lote de versão)** (2026-09-11), e o app está em **mt-v835**.
...
O motor (`app/aluno-builder.js`) encostou em **(fora de um lote de versão)** (2026-09-14).
