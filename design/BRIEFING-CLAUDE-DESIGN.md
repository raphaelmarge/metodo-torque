...
|---|---|
| App em | **mt-v771** |
| Estado do repo em | 2026-09-04 (commit `a5d2485`) |
| Repositório | `raphaelmarge/metodo-torque` |
| Lançamentos no histórico | 232 |
...
vez em **(fora de um lote de versão)** (2026-09-02), e o app está em **mt-v771**.
...
O motor (`app/aluno-builder.js`) encostou em **mt-v771** (2026-09-04).
...
| Versão | O que entrou |
|---|---|
| mt-v771 | o Início parou de dizer a mesma coisa três vezes ([#766](https://github.com/raphaelmarge/metodo-torque/pull/766)) |
