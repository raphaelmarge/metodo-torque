...
|---|---|
| App em | **mt-v777** |
| Estado do repo em | 2026-09-05 (commit `49d3092`) |
...
vez em **(fora de um lote de versão)** (2026-09-05), e o app está em **mt-v777**.
...
O motor (`app/aluno-builder.js`) encostou em **(fora de um lote de versão)** (2026-09-05).
