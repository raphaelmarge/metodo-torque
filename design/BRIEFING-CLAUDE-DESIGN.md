...
|---|---|
| App em | **mt-v696** |
| Estado do repo em | 2026-08-30 (commit `ea4a90c`) |
| Repositório | `raphaelmarge/metodo-torque` |
| Lançamentos no histórico | 158 |
...
vez em **mt-v669** (2026-08-29), e o app está em **mt-v696** — ou seja, **27 versões** aconteceram depois disso.
...
O motor (`app/aluno-builder.js`) encostou em **mt-v696** (2026-08-30).
