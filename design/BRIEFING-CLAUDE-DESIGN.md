...
|---|---|
| App em | **mt-v768** |
| Estado do repo em | 2026-09-04 (commit `4a63d24`) |
| Repositório | `raphaelmarge/metodo-torque` |
| Lançamentos no histórico | 229 |
...
vez em **(fora de um lote de versão)** (2026-09-02), e o app está em **mt-v768**.
...
O motor (`app/aluno-builder.js`) encostou em **mt-v768** (2026-09-04).
