...
|---|---|
| App em | **mt-v642** |
| Estado do repo em | 2026-08-27 (commit `ae6d412`) |
| Repositório | `raphaelmarge/metodo-torque` |
| Lançamentos no histórico | 104 |
...
vez em **mt-v601** (2026-08-25), e o app está em **mt-v642** — ou seja, **41 versões** aconteceram depois disso.
...
O motor (`app/aluno-builder.js`) encostou em **mt-v642** (2026-08-27).
