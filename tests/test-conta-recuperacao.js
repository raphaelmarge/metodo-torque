...
async function setup(opts={}){
  ...
  return {nodes,calls,memory,events,el,submit:async()=>{el('mgForm').events.submit({preventDefault(){}});await tick();await tick()},click:async id=>{el(id).events.click();await tick()}};
}
