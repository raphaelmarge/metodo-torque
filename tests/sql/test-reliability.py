...
for name in ['dados_guarda_hist', 'app_aluno_guarda_hist', 'app_lista_mescla', 'app_retorno_mescla', 'app_aluno_ativo', 'app_aluno_devolve', 'aluno_revoga_acesso', 'aluno_religa_acesso', 'app_aluno_faxina']:
...
# Fluxos canônicos completos, não só a edição direta da marca de revogação.
