...
async function main() {
  ...
  try {
    ...
    await preencherRegistro(p, '#gKg', '40'); await clicarControle(p, '#gSerie');
    ...
    await p.evaluate(() => window.__zeraDescanso());
    await clicarControle(p, '#gSemRegistro'); await p.click('#gFecharTreino');
    ...
    await preencherRegistro(p, '#gKg', '50'); await preencherRegistro(p, '#gReps', '9'); await clicarControle(p, '#gSalvar'); await p.click('#gVoltaFim');
    ...
    await preencherRegistro(novo.p, '#gKg', 'inválido'); await preencherRegistro(novo.p, '#gReps', '9');
    await novo.p.click('[data-gserie="1"]'); await novo.p.click('[data-gserie="0"]');
    ok(await novo.p.inputValue('#gKg') === 'inválido', 'navegação entre séries preserva até preenchimento inválido');
    await clicarControle(novo.p, '#gSerie');
    ...
    await preencherRegistro(erro.p, '#gKg', '10'); await preencherRegistro(erro.p, '#gReps', '3'); await clicarControle(erro.p, '#gSerie');
    ...
    await erro.p.evaluate(() => window.__restauraStorage()); await clicarControle(erro.p, '#gSerie');
    ...
    await erro.p.click('[data-gserie="0"]'); await clicarControle(erro.p, '#gDesfazSerie');
    ...
    await preencherRegistro(erro.p, '#gKg', 'inválido'); await erro.p.click('[data-gserie="1"]'); await clicarControle(erro.p, '#gPulaEx2'); await clicarControle(erro.p, '#gSemRegistro'); await erro.p.click('#gFecharTreino');
    ...
    await preencherRegistro(duas.p, '#gKg', '42');await preencherRegistro(duas.p, '#gReps', '8');await duas.p.click('[data-gserie="1"]');await duas.p.click('#gFechar');
    ...
    await preencherRegistro(duas.p, '#gKg', '43');await duas.p.click('[data-gserie="1"]');await duas.p.reload();await duas.p.waitForFunction(()=>window.__acSessao);
    ...
    await preencherRegistro(duas.p, '#gKg', 'inválido');await duas.p.click('[data-gserie="1"]');await duas.p.reload();await duas.p.waitForFunction(()=>window.__acSessao);
    await duas.p.evaluate(()=>document.querySelector('.guiabtn[data-g="1"]').click());
