...
(async()=>{
 ...
 await p.locator('#r809BlocoTipo').selectOption('repetir');await p.locator('#r809BlocoReps').fill('2');await p.locator('#r809AlvoValor').fill('.1');await p.locator('#r809AlvoUnidade').selectOption('km');await p.locator('#r809ZonaAlvo').selectOption(zid);await p.locator('#r809RecValor').fill('45');await p.locator('#r809RecUnidade').selectOption('s');await p.locator('#r809BlocoAdd').click();
