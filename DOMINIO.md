# 🌐 Como ter o site em www.torquesys.com.br

O sistema já está PRONTO pro domínio: quando `www.torquesys.com.br` apontar pro site, **visitantes caem direto na página de vendas do TORQUESYS**, e clientes já cadastrados caem no portal deles. Falta só a parte que é sua: registrar o domínio e apontar o DNS (uns 20 minutos + até 24h de propagação).

## Passo 1 · Registrar o domínio (~R$ 40/ano)

1. Abra **registro.br** (o órgão oficial dos domínios .br).
2. Pesquise **torquesys.com.br** — se estiver livre, clique em registrar.
...
4. Pague (Pix ou cartão). O domínio fica ativo em minutos.
   - 💡 Se `torquesys.com.br` estiver ocupado, boas alternativas: `torquesys.app.br`, `usetorquesys.com.br`, `torquesys.net.br`.
...
Se quiser fazer você mesmo: repositório **metodo-torque** → **Settings** → **Pages** → **Custom domain** → digite `www.torquesys.com.br` → Save → depois marque **Enforce HTTPS** (o cadeado 🔒 aparece em até 1h).

## O que acontece depois de ativar

- **www.torquesys.com.br** → página de vendas do TORQUESYS (visitante) ou portal (cliente logado neste aparelho; dá pra forçar o portal com `www.torquesys.com.br/?portal=1`).
...
## E os e-mails @torquesys.com.br?

O registro.br não hospeda e-mail, mas com o domínio na mão dá pra ter `contato@torquesys.com.br` de graça via Cloudflare Email Routing ou iCloud+ (encaminhando pro seu iCloud). Me pede que eu te guio quando quiser.
