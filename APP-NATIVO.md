# 📲 App NATIVO do TORQUESYS (Android/iOS de verdade)
...
4. Quando ficar verde ✅, clique na execução → seção **Artifacts** → baixe **torquesys-academia-apk**.
...
O primeiro app nativo é o **TORQUESYS academia** (`com.torquesys.academia`), que abre no portal. TORQUE PERSONAL e TORQUE NUTRI seguem o mesmo molde — é trocar o `appId`, o nome e a página inicial no `capacitor.config.json`. Me pede quando quiser que eu monto os outros dois.
